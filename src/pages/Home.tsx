    ...
    <div className="home-page">
      <div className="hero">
        ...
        <div className="hero-description">
          <p>
            複数人が参加するイベントで、各自の手持ち衣装・小物から、テーマに沿った組み合わせを自動提案します。
            お気に入りを保存していなくても、スーツ＋シャツやトップス＋ボトムスなど、登録アイテムから完成コーデ候補を作れます。
      ...
      <div className="features">
        <div className="feature-card no-hover">
          ...
          <h3>テーマに合う候補を自動選出</h3>
          <p>参加者ごとに、単品衣装、保存済みのお気に入り、登録したトップス・ボトムス・小物からの自動提案をまとめ、色・トーン・柄がテーマに合う候補を選びます（提出前の第1段階）</p>
        </div>
      ...
      <section className="info-section collaboration-home">
        ...
        <ol>
          ...
          <li>参加者: URL を開く → 名前登録 → <strong>単品・保存済みコーデ・登録アイテムからの自動提案を選出して提出</strong>（イベント日まで / 最大14日保持）</li>
