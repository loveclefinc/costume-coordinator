  ...
  return (
    <article className="online-usage-guide">
      <header className="online-usage-guide-header">
        <h1>オンライン提出の使い方</h1>
        <p>
          参加者が単品衣装、保存済みコーデ、登録アイテムからの自動提案をサーバーへ提出し、全員提出後に代表者が取り込むと、システムが組み合わせを自動決定する流れです。
        </p>
      </header>
      ...
      <section>
        ...
        <ol>
          ...
          <li>
            作成直後に自動登録されます。未登録の旧イベントは詳細の<strong>代表者をサーバーに登録</strong>を押してから写真提出
          </li>
          <li>
      ...
      <section>
        ...
        <ol>
          ...
          <li>単品衣装、保存済みコーデ、登録したトップス・ボトムス・小物からの自動提案をまとめ、イベントのテーマに合う候補を提出（枚数・容量制限あり）</li>
        </ol>
      </section>
      ...
      <section>
        <h2>削除</h2>
        <ul>
          <li>イベント一覧の削除: ローカル＋サーバー（管理者トークンが必要な場合あり）</li>
          <li>イベント詳細の「サーバー上のデータのみ削除」: サーバーだけ消し、端末のイベントは残す</li>
        </ul>
      </section>
